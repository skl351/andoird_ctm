 ...
 */
public class Order_two_detail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.order_two_detail);
        init();
        init_back();
        init_wangluo();
    }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray_data.getJSONArray("progress").length(); i++) {
                        View view = LayoutInflater.from(Order_two_detail.this).inflate(R.layout.item_progress, null);
