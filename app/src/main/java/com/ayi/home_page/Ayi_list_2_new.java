            ...
            public void onClick(View v) {
                if (index_flag!=-1){
                    if(getIntent().getStringExtra("flag").equals("zdg")){
                        Intent intent=new Intent(Ayi_list_2_new.this,Home_zdg_ok.class);
                    ...
                    if(getIntent().getStringExtra("flag").equals("zdg_cq")){
                        Intent intent=new Intent(Ayi_list_2_new.this,Home_zdg_cq_ok.class);
                        intent.putExtra("ayi_info",list.get(index_flag));
                        startActivity(intent);
                        Ayi_list_2_new.this.finish();
                    ...
                    if(getIntent().getStringExtra("flag").equals("bm")){
                        Intent intent=new Intent(Ayi_list_2_new.this,Home_baomu_ok.class);
                        intent.putExtra("ayi_info",list.get(index_flag));
                        startActivity(intent);
                        Ayi_list_2_new.this.finish();
                    ...
                    if(getIntent().getStringExtra("flag").equals("yuesao")){
                        Intent intent=new Intent(Ayi_list_2_new.this,Home_yuesao_ok.class);
                        intent.putExtra("ayi_info",list.get(index_flag));
                        startActivity(intent);
                        Ayi_list_2_new.this.finish();
                    ...
                    Toast.makeText(Ayi_list_2_new.this,"请选择阿姨",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0;i<size;i++){
                        ...
                        if (jsonObject_data.getJSONObject(i).has("out_price")){
                            item.setOut_price(jsonObject_data.getJSONObject(i).getString("out_price"));
                    ...
                    adapter=new Ayi_list_adapter_2(Ayi_list_2_new.this,list);
        ...
        asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    suijishu2();
//                    Show_toast.showText(Ayi_list_2_new.this,"这是部分阿姨，下拉刷新随机获得阿姨列表");
    ...
    public void suijishu2(){
        if (list.size()<=0){
            adapter.notifyDataSetChanged();
            progressBar1.setVisibility(View.GONE);
            Show_toast.showText(Ayi_list_2_new.this,"无搜索阿姨");
            index_flag=-1;
            return;
        }
