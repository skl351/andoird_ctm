 ...
 */
public class Home_yuesao_ok extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_yuesao_ok_view2);
    ...
    private void int_guyonghetong() {
        guyonghetong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Home_yuesao_ok.this, WebViewActivity.class);
        ...
        button_home_zdg_ok_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AyiApplication.getInstance().accountService().id().equals("")) {
                    ...
                    Intent intent = new Intent(Home_yuesao_ok.this, LoginActivity.class);
                    startActivity(intent);
                    return;
                }
                if (place1.getText().toString().isEmpty()) {
                    Show_toast.showText(Home_yuesao_ok.this, "用户资料不完整，请点击填写");
                    button_home_zdg_ok_btn.setEnabled(true);
                    return;
                }
                if (yuyue_time.getText().toString().isEmpty()) {
                    Show_toast.showText(Home_yuesao_ok.this, "预约时间不能为空");
                    button_home_zdg_ok_btn.setEnabled(true);
                    return;
                }
                if (ayi_id.equals("-1")) {
                    Show_toast.showText(Home_yuesao_ok.this, "请选择阿姨");
                    button_home_zdg_ok_btn.setEnabled(true);
                    return;
                }
                ...
                asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject jsonObject) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(Home_yuesao_ok.this, Order_pay.class);//跳转去支付
...
//                requestParams.put("payment","1");//0表示服务后付款1表示马上付款
    ...
    private void init_time_select_click() {
        ...
        click_yuyue_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (place1.getText().toString().isEmpty()) {
                    Show_toast.showText(Home_yuesao_ok.this, "请完善详细资料");
                    return;
                }
                Intent intent = new Intent(Home_yuesao_ok.this, Other_last2_time_select.class);
                intent.putExtra("flag", "ys");
                intent.putExtra("type_num", type_num);
                if (!biaozhi1.equals("")) {
    ...
    private void init_click_detailed_info_click() {
        click_detailed_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home_yuesao_ok.this, User_info_before.class);
                intent.putExtra("flag_place", "yuesao");
        ...
        select_ayi_by_hand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (yuyue_time_string.equals("")) {
                    Show_toast.showText(Home_yuesao_ok.this, "请选择时间");
                    return;
                }
                if (latitude.equals("") || longitude.equals("")) {
                    Show_toast.showText(Home_yuesao_ok.this, "请输入具体地址");
                    return;
                }
                Intent intent = new Intent(Home_yuesao_ok.this, Ayi_list_2_new.class);
                intent.putExtra("latitude", latitude);
                intent.putExtra("longitude", longitude);
                intent.putExtra("flag", "yuesao");
                intent.putExtra("type_num", type_num);
                //添加两个参数
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart(getString(R.string.client_home_yuesao));
        ...
        if (!need_hidden) {
            ...
            try {
                ...
                if (user_info.getShiji_dizhi().equals(AyiApplication.place)) {
                    ...
                    Show_toast.showText(Home_yuesao_ok.this, "请选择对应城市");
                }
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd(getString(R.string.client_home_yuesao));
